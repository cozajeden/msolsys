...
export const team: { sectionNum: string; headline: string[]; lead: string; members: TeamMember[] } = {
  ...
  members: [
    { name: "Arkadiusz Matuszak", role: "CEO · Strategia",   blurb: "20+ lat w branży FM. Prowadzi sprzedaż i wdrożenia.", photo: "/assets/arkadiusz2.jpg" },
    { name: "Radosław Semler",    role: "Software Engineer", blurb: "Projektuje i pisze rdzeń MSS. Odpowiada za jakość kodu.", photo: "/assets/radoslaw2.jpg" },
    { name: "Ryszard Napierała",  role: "System Administrator", blurb: "Infrastruktura, backupy, uptime. Pilnuje serwerów 24/7.", photo: "/assets/ryszard2.jpg" },
  ],
};
